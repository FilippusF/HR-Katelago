/* Katelago HR Hub
   Newsletter and request forms deliver through the same mail relay the
   main site contact form uses. Template downloads are direct links.
   Also applies the guide library search. */
(function () {
  ...
  document.querySelectorAll('form.field').forEach(function (form) {
    form.addEventListener('submit', function (e) {
      ...
      fetch(API, {
        ...
        notify(form, 'Something went wrong. Please email info@katelago.com and we will help.');
      });
    });
  });
